...
namespace AuctionService.Data
{
    ...
    {
        private static readonly int utcOffset = 7; // UTC+7
        ...
        private static void SeedData(AuctionDbContext? auctionDbContext)
        {
            ...
            if (auctionDbContext.Auction.Any())
            {
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEnd = DateTime.UtcNow.AddDays(10).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "GT",
            ...
            new Auction
            {
                ...
                ReservePrice = 90000,
                Seller = "alice",
                AuctionEnd = DateTime.UtcNow.AddDays(60).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Bugatti",
                    Model = "Veyron",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEnd = DateTime.UtcNow.AddDays(4).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Mustang",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "alice",
                AuctionEnd = DateTime.UtcNow.AddDays(30).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "BMW",
                    Model = "X1",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEnd = DateTime.UtcNow.AddDays(45).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "Spider",
            ...
            new Auction
            {
                ...
                ReservePrice = 150000,
                Seller = "alice",
                AuctionEnd = DateTime.UtcNow.AddDays(13).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Ferrari",
                    Model = "F-430",
            ...
            new Auction
            {
                ...
                Status = Status.Live,
                Seller = "bob",
                AuctionEnd = DateTime.UtcNow.AddDays(19).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "R8",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "tom",
                AuctionEnd = DateTime.UtcNow.AddDays(20).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Audi",
                    Model = "TT",
            ...
            new Auction
            {
                ...
                ReservePrice = 20000,
                Seller = "bob",
                AuctionEnd = DateTime.UtcNow.AddDays(48).AddHours(utcOffset),
                Item = new Item
                {
                    Make = "Ford",
                    Model = "Model T",
